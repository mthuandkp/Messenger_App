 ...
 * @author mthuan
 */
public class Sticker_Select extends javax.swing.JFrame {
     ...
     */
    public Sticker_Select() {
        initComponents();
        loadSticker();
    }

    public Sticker_Select(UserDTO u, GroupChatDTO g, JScrollPane sc) {
        this.user = u;
        this.group = g;
        this.scrollChat = sc;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sticker_Select.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sticker_Select().setVisible(true);
            }
        });
    }
