 ...
 * @author mthuan
 */
public class Block_Group_List extends javax.swing.JFrame {
     ...
     */
    public Block_Group_List() {
        initComponents();
    }

    public Block_Group_List(UserDTO user) {
        this.user = user;
        initComponents();
        initSocket();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh sách phòng chat bị khóa");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, -1));
        jPanel1.add(list_block, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 656, 530));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Block_Group_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Block_Group_List().setVisible(true);
            }
        });
    }
    ...
    private class loadBlockGroup implements Runnable {
        ...
        public loadBlockGroup(Socket socket, String randomKey, PublicKey pKeyServer, UserDTO u) {
            this.socket = socket;
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    //KHỞI TẠO DATA
                    map.put("command", "LOAD_LIST_GROUP_BLOCK");
    ...
    private class IOThread implements Runnable {
        ...
        public void run() {
            ...
            new Thread(new loadBlockGroup(socket, randomKey, pKeyServer, user)).start();
            try {
                ...
                while (!isBreak) {
                    ...
                    switch (maps.get("command")) {
                        case "LOAD_LIST_GROUP_BLOCK": {
                            List<GroupChatDTO> listGroup = new Gson().fromJson(maps.get("data"), new TypeToken<List<GroupChatDTO>>() {
                            }.getType());
                            String content = "";
                            Container conn = new Container();
                            for (GroupChatDTO group : listGroup) {
                                JPanel p = new Group_item_block(user, group);
                                p.setVisible(true);
                                content += p.toString();
                                conn.add(p);
                            }
