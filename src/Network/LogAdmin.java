...
public class LogAdmin extends javax.swing.JFrame {
    ...
    public LogAdmin() {
        ...
        new Thread(new readLogServer()).start();
    }
    ...
    private class readLogServer implements Runnable {
        
        @Override
        public void run() {
            while(true){
                try {
                    List<String> listStr = fileFunc.readTextFile("./src/file_Server/log.txt");
                    String str = "";
                    ...
                    JOptionPane.showMessageDialog(null, "Lỗi khi đọc log");
                }
