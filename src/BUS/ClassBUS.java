...
public class ClassBUS {
    ...
    public String getAllGroupChatWithoutBlock(int id) {
        ...
        List<JoinGroupDTO> listJoinGroup = joingroupdao.getAllJoinGroup(conn);
    ...
    public String getAllUserWithoutBlock(int id) {
        ...
        List<Message_11DTO> listMessage11 = message11dao.getAllMessage(conn);
    ...
    public String getMessage11(int idSend, int idReceive) {
        List<Message_11DTO> listMess = message11dao.getAllMessage(conn);
        List<ViewMessageDTO> listViewMess = viewmess11dao.getAllViewMessage(conn);
        List<UserDTO> listUser = userdao.getAllUser(conn);
        List<Message_11DTO> listMessValue = new ArrayList<>();

        if (listMess != null) {
            for (Message_11DTO mess : listMess) {
    ...
    public void viewAllMessage11(int idSend, int idReceive) {
        ...
        List<Message_11DTO> listMess11 = message11dao.getAllMessage(conn);

        for (Message_11DTO mess : listMess11) {
    ...
    public String getAllUserGroup(int idGroup) {
        ...
        for (UserDTO user : listUser) {
            ...
            for (JoinGroupDTO join : listJoinGroup) {
            ...
            if (mess.getId_sender() == idUser) {
                ...
                if (listFriend != null) {
                    for (FriendDTO friend : listFriend) {
                        if (friend.getId_user_01() == idUser && mess.getId_received() == friend.getId_user_02()) {
                            checkFriend = true;
                            break;
                        }
                    }
    ...
    public boolean isExistIdFriend(List<Message_11DTO> list, int id, int idUser2) {
        for (Message_11DTO mess : list) {
    ...
    public String viewAllMess11(int idView, int idSend) {
        ...
        List<Message_11DTO> listMess11 = message11dao.getAllMessage(conn);
        List<ViewMessageDTO> listViewMess = viewmess11dao.getAllViewMessage(conn);
        List<Message_11DTO> listMessSend = new ArrayList<>();
        ...
        if (listMess11 != null) {
            ...
            for(Message_11DTO mess : listMessSend){
